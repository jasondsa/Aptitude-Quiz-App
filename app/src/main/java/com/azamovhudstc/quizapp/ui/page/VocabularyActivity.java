...
public class VocabularyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (subject.equals(getString(R.string.vocabulary))) {
            questionsAnswerMap = Utils.getRandomQuestions(this, getString(R.string.vocabulary), Constants.QUESTION_SHOWING);
        }
        initView();
    ...
    private void createCountDownTimer(int timeC) {
        ...
        mCountDownTimer = new CountDownTimer(times[0], 1000) {
            ...
            public void onFinish() {
                ...
                Intent intentResult = new Intent(VocabularyActivity.this, GameOverActivity.class);
